The UnitRay property is a [Ray](https://developer.roblox.com/en-us/api-reference/datatype/Ray) directed toward the [Mouse](https://create.roblox.com/docs/reference/engine/classes/Mouse)'s
