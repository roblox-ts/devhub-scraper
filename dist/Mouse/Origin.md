The origin [`Mouse`](https://create.roblox.com/docs/reference/engine/classes/Mouse) property is a [`CFrame`](https://create.roblox.com/docs/reference/engine/datatypes/CFrame) indicating where
