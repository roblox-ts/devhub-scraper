...
[`Humanoid`](https://create.roblox.com/docs/reference/engine/classes/Humanoid), **SwimAnimation** determines the
[`Animation.AnimationId`](https://create.roblox.com/docs/reference/engine/classes/Animation#AnimationId) to play when its
[`state`](https://create.roblox.com/docs/reference/engine/classes/Humanoid#GetState) is `Enum.HumanoidStateType|Swimming`
