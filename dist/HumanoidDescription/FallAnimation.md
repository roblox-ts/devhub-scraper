...
[`state`](https://create.roblox.com/docs/reference/engine/classes/Humanoid#GetState) is [`Freefall`](https://create.roblox.com/docs/reference/engine/enums/HumanoidStateType).
