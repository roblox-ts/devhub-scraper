...
parented inside of a [Model](https://create.roblox.com/docs/reference/engine/classes/Model), and the model is expected to be an assembly of
[BasePart](https://create.roblox.com/docs/reference/engine/classes/BasePart) and [Motor6D](https://create.roblox.com/docs/reference/engine/classes/Motor6D); the root part of the assembly is expected to be
...
- Certain properties, such as [Humanoid.LeftLeg](https://create.roblox.com/docs/reference/engine/classes/Humanoid#LeftLeg) and [Humanoid.RightLeg](https://create.roblox.com/docs/reference/engine/classes/Humanoid#RightLeg), only
  work with R6.
...
- Can be dynamically rescaled by using special [NumberValue](https://create.roblox.com/docs/reference/engine/classes/NumberValue) objects parented
