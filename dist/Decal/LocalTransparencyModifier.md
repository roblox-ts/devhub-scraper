Acts as a multiplier for the [`Decal`](https://create.roblox.com/docs/reference/engine/classes/Decal)'s [`Decal.Transparency`](https://create.roblox.com/docs/reference/engine/classes/Decal#Transparency)
