...
the [`AnimationTrack`](https://create.roblox.com/docs/reference/engine/classes/AnimationTrack) must be playing to do so. It can also be used
in combination with [`AnimationTrack:AdjustSpeed()`](https://create.roblox.com/docs/reference/engine/classes/AnimationTrack#AdjustSpeed) to freeze the
