A Keyframe holds the [`Pose`](https://create.roblox.com/docs/reference/engine/classes/Pose)s applied to joints in a [`Model`](https://create.roblox.com/docs/reference/engine/classes/Model) at a
