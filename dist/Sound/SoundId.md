This property is the content ID of the sound file a [Sound](https://create.roblox.com/docs/reference/engine/classes/Sound) object is
...
will work when pasted directly into the SoundId property of a [Sound](https://create.roblox.com/docs/reference/engine/classes/Sound) in
Roblox studio, as Studio will automatically correct it, however if it is
being set from a [Script](https://create.roblox.com/docs/reference/engine/classes/Script) then the correct content ID will need to be
