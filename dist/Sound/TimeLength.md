The length of the [`Sound`](https://create.roblox.com/docs/reference/engine/classes/Sound) in seconds. If the [`Sound`](https://create.roblox.com/docs/reference/engine/classes/Sound) is not
