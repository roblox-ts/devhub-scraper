A container object that holds a [Player](https://create.roblox.com/docs/reference/engine/classes/Player)'s inventory. Any [Tool](https://create.roblox.com/docs/reference/engine/classes/Tool) in a player's
