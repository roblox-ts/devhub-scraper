The Teams service holds a game's [`Team`](https://create.roblox.com/docs/reference/engine/classes/Team) objects. [`Team`](https://create.roblox.com/docs/reference/engine/classes/Team) objects
