The Instance property of a [`Tween`](https://create.roblox.com/docs/reference/engine/classes/Tween) points to the [`Instance`](https://create.roblox.com/docs/reference/engine/classes/Instance)
