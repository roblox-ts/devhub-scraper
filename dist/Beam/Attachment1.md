The [Attachment](https://create.roblox.com/docs/reference/engine/classes/Attachment) the [Beam](https://create.roblox.com/docs/reference/engine/classes/Beam) ends at.
