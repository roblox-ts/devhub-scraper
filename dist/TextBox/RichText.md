This property determines whether the [TextBox](https://create.roblox.com/docs/reference/engine/classes/TextBox) renders the [TextBox.Text](https://create.roblox.com/docs/reference/engine/classes/TextBox#Text)
