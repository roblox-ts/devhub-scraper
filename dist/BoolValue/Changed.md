Fired whenever the [`BoolValue.Value`](https://create.roblox.com/docs/reference/engine/classes/BoolValue#Value) of the [`BoolValue`](https://create.roblox.com/docs/reference/engine/classes/BoolValue) is
