A [SoundGroup](https://create.roblox.com/docs/reference/engine/classes/SoundGroup) is used to manage the volume and effects on multiple [Sound](https://create.roblox.com/docs/reference/engine/classes/Sound)s
