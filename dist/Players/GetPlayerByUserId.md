This function searches each [`player`](https://create.roblox.com/docs/reference/engine/classes/Player) in [`Players`](https://create.roblox.com/docs/reference/engine/classes/Players) for
